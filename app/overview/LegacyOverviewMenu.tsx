...
/**
 * LegacyOverviewMenu — the original /overview "Jump to a feature" menu.
 *
 * Preserved verbatim when /overview was repurposed into the camera-driven grid
 * experience (see ./page.tsx). This file is intentionally NOT a route — Next's
 * App Router only treats page/layout/route files as routes, so this colocated
 * component is dead-safe and kept only so the old UI is never lost.
 *
 * To restore the menu, re-export this as the default from a `page.tsx`.
 */
...
export default function LegacyOverviewMenu() {

  ...
  return (
    <main className="relative w-screen h-screen overflow-hidden bg-black flex flex-col justify-between pt-10 pb-6 px-12">
      ...
      <div
        ...
        style={{
          backgroundImage: `url('https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=1200&auto=format&fit=crop&q=80')`,
        }}
      />
      ...
      <div className="relative z-20 flex-1 w-full flex flex-col justify-center items-center mt-6 min-h-0">
        ...
        <div className="w-full max-w-4xl grid grid-cols-3 gap-8 mb-16">
          {tabs.map((tab) => (
            ...
            >
              <span
                className={`text-base md:text-lg font-bold tracking-widest uppercase transition-all duration-300 ${
                  activeTab === tab.id
              ...
              <span
                className={`text-xs md:text-sm tracking-wide mt-1.5 font-light transition-all ${
                  activeTab === tab.id
                    ? "text-purple-300/60"
              ...
              <div
                className={`h-0.5 mt-4 rounded-full transition-all duration-500 ${
                  activeTab === tab.id
        ...
        <div className="w-full flex justify-end px-12">
          <div className="w-full max-w-lg flex flex-col gap-6">
            ...
            >
              ...
              <span className="text-[9px] text-white/20 font-bold uppercase mr-1">
                10:30 AM
              </span>
            </motion.div>
            ...
            >
              ...
              <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-2xl rounded-tr-none px-5 py-4 backdrop-blur-md shadow-[0_4px_30px_rgba(168,85,247,0.05)] max-w-[95%]">
                <p className="text-white/90 text-sm font-medium leading-relaxed">
                  How about a relaxed brunch at a cozy cafe in Seongsu-dong,
                  followed by a walk along Seoul Forest? It&apos;s a lovely spot
                  for a spring day.
                </p>
              </div>
              <span className="text-[9px] text-purple-400/30 font-bold uppercase mr-1">
                10:30 AM
              </span>
            </motion.div>
          </div>

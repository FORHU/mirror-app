  ...
  return (
    <main className="relative w-screen h-screen overflow-hidden bg-black flex flex-row p-6 gap-6 justify-between">
      ...
      <div
        ...
        style={{
          backgroundImage: `url('https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=1200&auto=format&fit=crop&q=80')`,
        }}
      />
        ...
        <div className="flex flex-col gap-6">
          <div className="flex items-center justify-between border-b border-white/5 pb-4.5">
            ...
            <div className="flex flex-col text-right">
              ...
              <span className="text-white/40 text-xs font-bold tracking-widest uppercase mt-0.5">
                Thursday, April 17
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6 mt-2">
            ...
            <div className="flex flex-col items-start gap-2">
              <span className="text-white/30 text-[10px] md:text-xs uppercase font-bold tracking-wider">
                ✦ You Asked
              </span>
              <div className="bg-white/5 border border-white/10 rounded-2xl rounded-tl-none px-4 py-3.5 max-w-[95%]">
                <p className="text-white/90 text-xs md:text-sm font-medium leading-relaxed">
                  I have a birthday dinner party at a downtown Korean restaurant
                  tomorrow at 7 PM. What should I wear?
                </p>
              </div>
            </div>
            ...
            {/* AI Response */}
            <div className="flex flex-col items-start gap-2">
              <span className="text-purple-400 text-[10px] md:text-xs uppercase font-bold tracking-wider">
                ✦ AI Answer
              </span>
              <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-2xl rounded-tl-none px-4.5 py-4 max-w-[98%]">
                <p className="text-white/80 text-xs md:text-sm font-medium leading-relaxed">
                  Tomorrow evening will bring light rain, with a temperature
                  around 19°C. It might feel a bit chilly, so I recommend an
                  outfit that&apos;s stylish yet warm enough for the weather.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              <div className="flex flex-col gap-2.5">
                <span className="text-xs text-purple-400 font-extrabold uppercase tracking-widest">
                  Look 1
                </span>
                ...
                <div className="aspect-[4/5] rounded-xl overflow-hidden my-2.5 border border-white/10">
                  ...
                  <img
                    src="https://images.unsplash.com/photo-1525507119028-ed4c629a60a3?w=200&auto=format&fit=crop"
                    alt=""
        ...
        <div className="flex flex-col gap-3 mt-2">
          ...
          <div className="flex flex-col gap-3 bg-white/5 border border-white/10 rounded-2xl p-5 backdrop-blur-md">
            ...
            <div className="flex gap-3.5 border-l-2 border-purple-500 pl-3.5">
              <span className="text-purple-400 text-sm font-bold shrink-0 mt-0.5">
                07:00 PM
              </span>
              <div className="flex flex-col">
                ...
                <span className="text-white/40 text-xs mt-0.5 flex items-center gap-1.5">
                  <MapPin className="w-3.5 h-3.5" /> Seoul Korean House, 123
                  Main St, Seoul
                </span>
              </div>
            </div>
            ...
            <div className="flex gap-3.5 border-l-2 border-pink-500 pl-3.5 mt-2">
              <span className="text-pink-400 text-sm font-bold shrink-0 mt-0.5">
                09:30 PM
              </span>
              <div className="flex flex-col">
                <span className="text-white text-sm font-bold">
                ...
                <span className="text-white/40 text-xs mt-0.5 flex items-center gap-1.5">
                  <MapPin className="w-3.5 h-3.5" /> Cafe Layered, 456 Cafe St,
                  Seoul
                </span>
              </div>
            </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-5 flex flex-col gap-3.5 relative overflow-hidden backdrop-blur-md">
            ...
            <div className="flex justify-between items-center px-1">
              <div className="flex flex-col">
                ...
                <span className="text-white text-base font-extrabold mt-0.5">
                  32 min{" "}
              ...
              <div className="text-right">
                ...
                <span className="text-amber-400 text-xs font-bold mt-0.5 block">
                  Moderate Traffic
                </span>
              </div>
            </div>

...
const PRODUCT_ITEMS: ProductItem[] = [
  ...
  },
  {
    id: "1",
    label: "Hoodie",
    imageUrl: "https://pngimg.com/uploads/hoodie/hoodie_PNG12.png",
  },
  {
    id: "2",
    label: "Jeans",
    imageUrl: "https://pngimg.com/uploads/jeans/jeans_PNG7.png",
  },
  {
    id: "3",
    label: "Sneakers",
    imageUrl: "https://pngimg.com/uploads/shoe/shoe_PNG7654.png",
  },
  {
    id: "4",
    label: "Dress",
    imageUrl: "https://pngimg.com/uploads/dress/dress_PNG46.png",
  },
];
    ...
    <main className="relative w-screen h-screen overflow-hidden bg-black">
      <AnimatePresence>
        {photo ? (
          ...
          >
            <p className="text-[#6b5b95] text-2xl">
              No photo found. Go back and strike a pose! ✌️
            </p>
          </motion.div>
        )}
      </AnimatePresence>
          ...
          renderIcon={(item, active) => (
            ...
            >
              {item.imageUrl ? (
                ...
                <span
                  className={`font-semibold text-white transition-all duration-150 ${active ? "text-base" : "text-sm"}`}
                >
                  None
                </span>
              )}

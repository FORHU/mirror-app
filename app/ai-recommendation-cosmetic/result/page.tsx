...
const DEMO_PRODUCTS = [
  {
    ...
    why: [
      "Targets your 68% hydration gap",
      "Non-greasy for combination skin",
      "Calms enlarged pores",
    ],
  },
  {
    id: 2,
    ...
    why: [
      "Cleans without over-drying T-zone",
      "Maintains barrier for combination skin",
      "Reduces shine without stripping",
    ],
  },
  {
    id: 3,
    ...
    why: [
      "Visibly minimises enlarged pores",
      "Evens out uneven skin tone",
      "Regulates sebum on oily areas",
    ],
  },
  {
    id: 4,
    ...
    why: [
      "Prevents fine line deepening",
      "Protects uneven tone from worsening",
      "Lightweight for combination skin",
    ],
  },
  {
    id: 5,
    ...
    why: [
      "Repairs mild dehydration overnight",
      "Soothes low-sensitivity skin",
      "Balances dry patches",
    ],
  },
  {
    id: 6,
...
export default function CosmeticResultPage() {
  ...
  useEffect(() => {
    garmentService
      ...
      .then((garments) =>
        setGarmentImages(
          garments.slice(0, DEMO_PRODUCTS.length).map((g) => g.imageUrl),
        ),
      )
      .catch(() => {});
  }, []);
  ...
  const pagedProducts = DEMO_PRODUCTS.slice(
              ...
              >
                <div
                  style={{
                    ...
                    height: "9px",
                    borderRadius: "50%",
                    background: DEMO_SKIN.skinTone.hex,

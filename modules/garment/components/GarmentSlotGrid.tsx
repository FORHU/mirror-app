    ...
    <div className={cn("flex flex-col gap-0 w-full h-full", className)}>
      ...
      <div className="flex flex-col gap-1.5" style={{ height: "45%" }}>
        ...
        <div className="flex flex-row gap-1.5 flex-3">
          ...
          <div className="flex flex-row gap-1 flex-1">
            ...
            <GarmentSlotCard
              slot={s(FittingSlot.HeadGarment)}
              isActive={isA(FittingSlot.HeadGarment)}
              index={0}
              onPress={onSlotPress}
              className="flex-1"
            />
        ...
        <div className="flex flex-row gap-1.5 flex-3">
          ...
          <div className="flex flex-row gap-1 flex-1">
            <GarmentSlotCard
              slot={rEar}
              isActive={isA(FittingSlot.Earrings)}
              index={1}
              onPress={onSlotPress}
              className="flex-none w-[22%]"
            />
            <GarmentSlotCard
              slot={s(FittingSlot.Glasses)}
              isActive={isA(FittingSlot.Glasses)}
              index={2}
              onPress={onSlotPress}
              className="flex-1"
            />
        ...
        <div className="flex flex-row gap-1.5 flex-3">
          ...
          <div className="flex flex-row gap-1 flex-1">
            <div className="flex-none w-[22%]" />
            <GarmentSlotCard
              slot={s(FittingSlot.NeckAccessory)}
              isActive={isA(FittingSlot.NeckAccessory)}
              index={4}
              onPress={onSlotPress}
              className="flex-1"
            />
      ...
      <div className="flex flex-row gap-1.5" style={{ height: "50%" }}>
        ...
        <div className="flex flex-col gap-1.5 flex-1">
          <GarmentSlotCard
            slot={upperSlot}
            isActive={
              isA(FittingSlot.UpperGarment) || isA(FittingSlot.FullGarment)
            }
            index={6}
            onPress={onSlotPress}
            className="flex-[2.2]"
          />
          <GarmentSlotCard
            slot={s(FittingSlot.WaistAccessory)}
            isActive={isA(FittingSlot.WaistAccessory)}
            index={7}
            onPress={onSlotPress}
            className="flex-[0.55]"
          />
      ...
      <div className="flex flex-row gap-1.5" style={{ height: "35%" }}>
        ...
        <div className="flex flex-row gap-1 flex-1">
          <div className="flex-none w-[22%]" />
          <GarmentSlotCard
            slot={s(FittingSlot.LowerGarment)}
            isActive={isA(FittingSlot.LowerGarment)}
            coveredBy={fullGarment}
            index={8}
            onPress={onSlotPress}
            className="flex-[1.4]"
          />
      ...
      <div className="flex flex-row gap-1.5" style={{ height: "14%" }}>
        ...
        <div className="flex-none w-[14%]" />
        <GarmentSlotCard
          slot={s(FittingSlot.FootGarment)}
          isActive={isA(FittingSlot.FootGarment)}
          index={10}
          onPress={onSlotPress}
          className="flex-1"
        />

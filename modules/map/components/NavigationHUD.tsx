...
function getProximity(distanceM: number) {
  if (distanceM <= 100)
    return { color: "#ef4444", label: "Arriving Now", pulse: true };
  if (distanceM <= 300)
    return { color: "#f97316", label: "Almost There", pulse: false };
  if (distanceM <= 800)
    return { color: "#facc15", label: "Getting Close", pulse: false };
...
const NavigationHUD = () => {
  ...
  return (
    <div
      className="hud-container pointer-events-none fixed inset-0 flex flex-col justify-between"
    ...
    >
      ...
      <div className="flex justify-between items-start">
        ...
        <div className="flex flex-col gap-1">
          <span
            className="text-(--hud-text-label) text-xs uppercase tracking-widest"
        ...
        <div className="flex flex-col items-end gap-1">
          ...
          <span
            className="text-(--hud-text-secondary) text-3xl font-light"
            style={{ textShadow: "var(--hud-text-shadow)" }}
          >
            {eta}
          </span>

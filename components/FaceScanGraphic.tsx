...
const POINTS: Array<[number, number]> = [
  // jaw / face outline
  [50, 8], [30, 14], [18, 30], [13, 52], [16, 74], [27, 95], [42, 110], [50, 116],
  [58, 110], [73, 95], [84, 74], [87, 52], [82, 30], [70, 14],
  // brows
  [33, 40], [42, 36], [50, 37], [58, 36], [67, 40],
  // eyes
  [36, 49], [44, 47], [56, 47], [64, 49],
  // nose
  [50, 50], [50, 62], [44, 70], [50, 72], [56, 70],
  // mouth
  [40, 84], [50, 82], [60, 84], [50, 90],
];
...
const LINKS: Array<[number, number]> = [
  ...
  [19, 20], [21, 22],
  // nose bridge + base
  [16, 23], [23, 24], [24, 25], [25, 26], [26, 27], [27, 24],
  // mouth
  [28, 29], [29, 30], [28, 31], [30, 31],
  // a few cross-mesh lines for the "wireframe" feel
  [14, 19], [18, 22], [19, 23], [22, 23], [25, 28], [27, 30], [1, 14], [13, 18],
];
      ...
      {["tl", "tr", "bl", "br"].map((c) => (
        <span
          ...
          style={{
            ...
            borderStyle: "solid",
            borderWidth: 0,
            ...(c[0] === "t" ? { top: 12, borderTopWidth: 2 } : { bottom: 12, borderBottomWidth: 2 }),
            ...(c[1] === "l" ? { left: 12, borderLeftWidth: 2 } : { right: 12, borderRightWidth: 2 }),
          }}
        />
      ))}
